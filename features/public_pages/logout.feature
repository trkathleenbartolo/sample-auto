Feature: Logout
    ...
    Scenario Outline: I should be logged out successfully when I click on Logout link from the User dropdown
        ...
        And I should be navigated back to TechDirect Home page {td.home.url}
        ...
        Examples:
            ...
            | Tech     | kathleen.bartolo+t1@tooltwist.com | Logmein+1234 | Hi Alexis!    |
            | Client   | kathleen.bartolo+c1@tooltwist.com | Logmein+1234 | Hi Geek Test! |